...
export function Header({
  ...
  const primaryNavItems = [
    ...
    { id: 'agent-loop', label: 'Agent Loop', icon: Bot },
  ...
  // Complete list for mobile horizontal pill bar
  const allNavItems = [
    ...
    { id: 'blueprints', label: '30-Day Blueprint', icon: Download },
  ];
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[var(--color-border)] bg-[var(--color-surface)]/95 backdrop-blur-md shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3 xl:gap-4 shrink-0 min-w-0">
          ...
          >
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <span className="text-xs font-semibold px-1.5 py-0.5 rounded-md bg-blue-50 dark:bg-blue-950/40 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-800 font-mono hidden xs:inline-block">
                AI Head of Growth
              </span>
            </div>
          </button>
          ...
          {/* Inlined Primary Navigation for Quick 1-Click Access on Desktop */}
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 ml-2 sm:ml-4 lg:ml-6">
          {/* 1-Click PDF Architecture Blueprint Download */}
          <a
            href="/Meet-Eric-Architecture-Blueprint.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 h-8 px-2 sm:px-3 rounded-md border border-blue-200 dark:border-blue-800/80 bg-blue-50/90 dark:bg-blue-950/60 hover:bg-blue-100 dark:hover:bg-blue-900/60 text-blue-700 dark:text-blue-300 text-xs font-semibold shadow-2xs transition-colors whitespace-nowrap shrink-0"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="h-8 text-xs font-medium border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-text-primary)] hover:bg-[var(--color-panel-subtle)] gap-1 px-2 sm:px-2.5 shadow-2xs whitespace-nowrap shrink-0"
              >
      ...
      {/* Mobile Horizontal Scrollable Pill Navigation (Restored & Optimized) */}
      <div className="md:hidden border-t border-[var(--color-border)] bg-[var(--color-surface)]/90 backdrop-blur-xs py-1.5 px-3 overflow-x-auto no-scrollbar flex items-center gap-1.5 scroll-smooth">
