  ...
  return (
    <div className="w-full rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 sm:p-6 shadow-xs">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-md bg-blue-50 dark:bg-blue-950/40 text-blue-800 dark:text-blue-300 border border-blue-200 dark:border-blue-800 font-bold uppercase">
                  {b.language}
                </span>
              </div>
              ...
              <div className="text-[11px] font-mono text-[var(--color-text-muted)] mt-1 truncate">
                {b.filename}
              </div>
            </button>
          );
      ...
      <div className="mt-5 rounded-xl border border-[var(--color-border)] bg-slate-950 text-slate-100 p-4 font-mono text-xs overflow-x-auto shadow-inner">
        ...
        <pre className="leading-relaxed whitespace-pre text-[11px]">{active.code}</pre>
      </div>
    </div>
  );
}
